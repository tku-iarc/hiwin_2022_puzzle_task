...
so_file = "./modbus_file/Hiwin_API.so"
modbus = CDLL(so_file)
...
if __name__ == "__main__":
    ...
    LIN_XYZ   = [204.049, 368, 293.5, 180, 0, 90]      # XYZABC
    ...
    C_LIN_Angle = (c_double * len(LIN_Angle))(*LIN_Angle)       # C Array
    C_LIN_XYZ = (c_double * len(LIN_XYZ))(*LIN_XYZ)             # C Array
    ...
    while 1:
        ...
        # modbus.Holding_Registers_init()
        # modbus.HOME() # 1 RUN
        # modbus.PTP(1, 200, 10, 1, 0, C_PTP_XYZ)
        modbus.LIN(1, 200, 10, 1, 0, C_LIN_XYZ)
        # modbus.DO(IO_Port,0) # 1 -> on ; 0 -> off
